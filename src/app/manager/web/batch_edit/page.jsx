...
import {
  ...
  getWebFieldGroups,
  getWebFieldTypes,
} from "@/components/pages/manager/utils/webBatchEditUtils";

const ACTIVE_CONFIG = PAGE_CONFIGS.web || PAGE_CONFIGS.artwork;

export default function WebBatchEditPage() {
  const csvHeaders = [
    "artist",
    "title",
    "type",
  ...
  return (
    <BatchEditLayout
      ...
      getSchemaFields={getWebSchemaFields}
      getFieldGroups={getWebFieldGroups}
      getFieldTypes={getWebFieldTypes}
      alphabetField="title"
      csvHeaders={csvHeaders}
      renderDeleteRow={renderDeleteRow}
      renderList={renderList}
      titles={{ en: "Web Batch Edit", cn: "网页批量编辑" }}
